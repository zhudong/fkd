...
public class CardTOUActivity extends BaseActivity {
    ...
    public View setInitView() {
        ...
        url = Constants.WebWiewUrl.getUrl(Constants.WebWiewUrl.GIFT_CARD_TERMS_AND_CONDITIONS) + "?decorator=empty" + "&uin=" + accountManager.mUin + "&ticket=" + accountManager.mH5Ticket + "&localeCode=" + accountManager.getLocaleCode();
        TOUWv.loadUrl(url);
