 ...
 */
public class ParcelPayMethodActivity extends BaseActivity {
...
//                                mIndex = (int) v.getTag();
                        ...
                        for (int i = 0; i < paymantlistList.size(); i++) {
                            ...
                            View convertView = LayoutInflater.from(ParcelPayMethodActivity.this).inflate(R.layout.payment_item, null);
...
//                                nameTv.setText(getString(R.string.String_adyen_pay));
                                logoIv.setImageDrawable(ContextCompat.getDrawable(ParcelPayMethodActivity.this, R.mipmap.adyen_pay));
                            }
...
//                                nameTv.setText(getString(R.string.String_krbank_pay));
                                logoIv.setImageDrawable(ContextCompat.getDrawable(ParcelPayMethodActivity.this, R.mipmap.krbank_pay));
                            }
                            if (TextUtils.equals(item.getPaycode(), Constants.GIFT_CARD_PAYMENT_ALIPAY)) {
//                                nameTv.setText(getString(R.string.String_ali_pay));
                                logoIv.setImageDrawable(ContextCompat.getDrawable(ParcelPayMethodActivity.this, R.mipmap.pay_alipay));
                            }
                            if (TextUtils.equals(item.getPaycode(), Constants.GIFT_CARD_PAYMENT_WXPAY)) {
//                                nameTv.setText(getString(R.string.String_weixin_pay));
                                logoIv.setImageDrawable(ContextCompat.getDrawable(ParcelPayMethodActivity.this, R.mipmap.pay_wechat));
                            }
                            if (TextUtils.equals(item.getPaycode(), Constants.GIFT_CARD_PAYMENT_DAOUPAY)) {
//                                nameTv.setText(item.getPayname());
                                logoIv.setImageDrawable(ContextCompat.getDrawable(ParcelPayMethodActivity.this, R.mipmap.daoupay));
                            }
                            nameTv.setText(item.getPayname());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.payment_coupon_layout:
                intent.setClass(ParcelPayMethodActivity.this, CouponActivity.class);
                intent.putExtra(ParcelPayMethodActivity.SHIPPING_FEE, mShippingFee);
