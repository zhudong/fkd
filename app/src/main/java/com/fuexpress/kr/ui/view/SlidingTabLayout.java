...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public boolean isSetTextTextAllCaps = true;

    public void setTheTextAllCaps(boolean isSet) {
        isSetTextTextAllCaps = isSet;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setAllCaps(isSetTextTextAllCaps);
