...
import com.fuexpress.kr.utils.AndroidBug5497Workaround;
...
public class MyPayActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        titleBarView = (TitleBarView) findViewById(R.id.adyen_titlebar);
        ...
        this.mMainLayout = (ScrollView) this.findViewById(R.id.main_layout);
...
//        this.showInputKeyboard();
        ...
        if (adyenInfo.details != null) {
            ...
            isSaved = false;
            mCreditCardHolderName.requestFocus();
