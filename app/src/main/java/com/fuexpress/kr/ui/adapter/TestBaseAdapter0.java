...
public class TestBaseAdapter0 extends BaseAdapter implements
    ...
    public TestBaseAdapter0(Context context, List<CsParcel.ParcelItemList> salesOrderItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            ParcelItemView2 parcelItemView = new ParcelItemView2(mContext);
            convertView = parcelItemView;
            holder.mParcelItemView = parcelItemView;
            convertView.setTag(holder);
        }
        holder = (Holder) convertView.getTag();
        holder.mParcelItemView.setItem(getItem(position));
//        convertView.setOnClickListener(this);
    ...
    static class Holder {
        ParcelItemView2 mParcelItemView;
    }
}
