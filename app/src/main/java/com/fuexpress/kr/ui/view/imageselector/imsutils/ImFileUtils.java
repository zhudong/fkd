package com.fuexpress.kr.ui.view.imageselector.imsutils;
...
public class ImFileUtils {
    ...
    public static File createTmpFile(Context context, String filePath) {
        ...
        if (externalStorageState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            return new File(dir, timeStamp + AccountManager.getInstance().mUin + ".jpg");
        } else {
            File cacheDir = context.getCacheDir();
            return new File(cacheDir, timeStamp + AccountManager.getInstance().mUin + ".jpg");
        }
