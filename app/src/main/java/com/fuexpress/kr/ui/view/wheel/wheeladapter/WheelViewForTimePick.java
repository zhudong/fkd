...
import com.fuexpress.kr.ui.view.wheel.OnWheelScrollListener;
import com.fuexpress.kr.ui.view.wheel.WheelAdapter;
 ...
 */
public class WheelViewForTimePick extends View {
    /**
     * 滚动的持续时�?
     */
     ...
     * Constructor
     */
    public WheelViewForTimePick(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public WheelViewForTimePick(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }
     ...
     * Constructor
     */
    public WheelViewForTimePick(Context context) {
        super(context);
        initData(context);
    }
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        centerDrawable.setBounds(0, 0, getWidth(), center
                + offset);
