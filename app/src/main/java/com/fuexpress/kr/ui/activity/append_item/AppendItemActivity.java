...
//                deleteItem();
    ...
    private void deleteItem() {
        showProgressDiaLog(SweetAlertDialog.PROGRESS_TYPE, getString(R.string.string_deleting));
    ...
    public void saveItem(final ItemAppendBean bean, final int index, final ParcelItemUseCase.IOperareResult operareResult) {
        showProgressDiaLog(SweetAlertDialog.PROGRESS_TYPE, getString(R.string.stirng_item_saving));
