...
public class NetworkUtil {
    ...
    private static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            LogUtils.e(TAG, "Active network info: " + in); 
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; ++i) {
                    LogUtils.e(TAG, "NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    LogUtils.e(TAG, "NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    LogUtils.e(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    LogUtils.e(TAG, "NetworkInfo[" + i + "]: " + info[i]);
                }

                LogUtils.e(TAG, "\n");
            } else {
                LogUtils.e(TAG, "All network information are null.");
            }
        }
