...
public class LoginByPhoneActivity extends BaseActivity implements IWXAPIEventHandler {
    ...
    public void onEventMainThread(BusEvent event) {
        ...
        switch (event.getType()) {
            ...
            case BusEvent.LOGIN_FAILURE:
                ...
                //showConfirmDialog(event.getStrParam());
                if (event.getIntValue() == -29) showConfirmDialog(event.getStrParam());
                else mViewUtils.toast(event.getStrParam());
                break;
    ...
    public void showConfirmDialog(String text) {
        ...
        dialog.setNegativeButton(getString(R.string.my_gift_card_order_binding_dialog_config), new DialogInterface.OnClickListener() {
            @Override
