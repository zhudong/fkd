...
public class AddressSearchActivity extends BaseActivity implements RefreshListView.OnRefreshListener, AdapterView.OnItemClickListener {
    ...
    private void initData() {
        ...
        mIsChooseType = getIntent().getBooleanExtra(KEY_IS_CHOOSE, false);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = mIsChooseType ? new Intent() : new Intent(this, AddNewAddressActivity.class);
        ...
        switch (event.getType()) {
            case BusEvent.GET_ADDRESS_LIST_COMPLETE:
                ...
                if (event.getBooleanParam()) {
                    ...
                    mTv_in_search_result_item_head_total.setText(getString(R.string.search_result_brackets, event.getIntValue()));
                } else {
